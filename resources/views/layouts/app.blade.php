    ...
    <div id="app" class="container">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm sticky-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse dflex justify-content-between" id="navbarSupportedContent">
                    @else
                    <div class="collapse navbar-collapse dflex justify-content-end" id="navbarSupportedContent">
                        @endif
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('transaksi.peminjaman') }}">Layani peminjaman</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('transaksi.pengembalian') }}">Layani Pengembalian</a>
                            </li>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <!-- Add more navigation items here as needed -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('transaksi.list') }}">Peminjaman</a>
                            </li>
                            <!-- Add more navigation items here as needed -->
                        </ul>
                        @endif
